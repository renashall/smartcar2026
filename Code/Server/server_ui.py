...
""")
        ...
        self.label.setGeometry(QtCore.QRect(50, 145, 300, 42))
        font = QtGui.QFont()
        font.setFamily("3ds")
        ...
        # Default red (Server Off); server_main toggles to green when On.
        self.label.setStyleSheet("background:transparent;border:none;color:#e02d2d;")
        self.label.setObjectName("label")
        self.label_ip = QtWidgets.QLabel(server_ui)
        self.label_ip.setGeometry(QtCore.QRect(40, 102, 320, 26))
        font = QtGui.QFont()
        font.setFamily("3ds")
        ...
        self.label_battery = QtWidgets.QLabel(server_ui)
        self.label_battery.setGeometry(QtCore.QRect(40, 72, 320, 24))
        font = QtGui.QFont()
        font.setFamily("3ds")
        ...
        self.label_2.setGeometry(QtCore.QRect(0, 0, 400, 41))
        font = QtGui.QFont()
        font.setFamily("3ds")
        ...
        self.label_2.setStyleSheet("background:transparent;border:none;color:#e8eaed;letter-spacing:3px;")
        ...
        self.pushButton_Close.setStyleSheet("QPushButton{border:none;border-radius:0px;background:transparent;color:#e8eaed;font-size:26px;font-weight:bold;}QPushButton:hover{background:#e02d2d;color:#ffffff;}")
        self.pushButton_Close.setObjectName("pushButton_Close")
        self.pushButton_Min = QtWidgets.QPushButton(server_ui)
        self.pushButton_Min.setGeometry(QtCore.QRect(300, 0, 50, 40))
        self.pushButton_Min.setStyleSheet("QPushButton{border:none;border-radius:0px;background:transparent;color:#e8eaed;font-size:26px;font-weight:bold;}QPushButton:hover{background:#3b4049;color:#ffffff;}")
